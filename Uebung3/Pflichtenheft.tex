...
\begin{figure}[h!]
    \begin{center}
        \fbox{\includegraphics[width=1\textwidth]{01-Auswertung}}
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \fbox{\includegraphics[width=1\textwidth]{02-Stimmverteilung}}
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \fbox{\includegraphics[width=\textwidth]{03-Vergleich}}
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \fbox{\includegraphics[width=\textwidth]{04-Zusatzstatistiken}}
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \fbox{\includegraphics[width=\textwidth]{Datenmodell}}
    \end{center}
    \caption{Datenmodell}
